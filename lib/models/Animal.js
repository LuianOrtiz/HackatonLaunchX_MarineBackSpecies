...
class Animal {
     ...
     * @param {Arraystring} asosiaciones 
     * @param {string} url_info 
     * @param {int} fk_habitad 
     * @param {int} fk_risk_status 
     */
    constructor(id, name, scientific_name, description, url_image, asosiaciones, url_info, fk_habitad, fk_risk_status){
        this.id = id
        this.name = name
        this.scientific_name = scientific_name
        this.description = description
        this.url_image = url_image
        this.asosiaciones = asosiaciones
